...
public class ProductoDAOimpl extends ConexionBD implements ProductoDAO {
    ...
    public void insert(Producto producto) throws Exception {
        try {
            ...
            throw new Exception("Error insert(Producto producto): " + e.getMessage());
        } finally {
            this.desconectar();
        }
    ...
    public void update(Producto producto) throws Exception {
        try {
            ...
            throw new Exception("Error al actualizar el producto update(Producto producto): " + e.getMessage());
        } finally {
            this.desconectar();
        }
    ...
    public void delete(int id) throws Exception {
        try {
            ...
            System.out.println("ERROR EN SQL delete(int id): " + e.getMessage());
            e.printStackTrace();
        } finally {
            this.desconectar();
        }
    ...
    public Producto getById(int id) throws Exception {
        ...
        try {
            ...
            System.out.println("ERROR EN SQL getById(int id): " + e.getMessage());
            e.printStackTrace();
